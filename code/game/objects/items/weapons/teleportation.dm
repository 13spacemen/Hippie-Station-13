...
/obj/item/weapon/hand_tele/attack_self(mob/user as mob)
	...
	if(!current_location||current_location.z==2||current_location.z==10||current_location.z>=7)//If turf was not found or they're on z level 2 or >7 which does not currently exist.
