...
/datum/admins/proc/show_player_panel(var/mob/M in mob_list)
	...
	if (M.client)
		...
		body += "<A href='?src=\ref[src];goodcurity=\ref[M]'>Grant Goodcurity</A> | "
		body += "<A href='?src=\ref[src];removegoodcurity=\ref[M]'>Remove Goodcurity</A> | "
...
/datum/admins/proc/Secrets()
	...
	if(check_rights(R_FUN,0))
		dat += {"
			...
			<A href='?src=\ref[src];secretsfun=meteor'>Spawn a Meteor Shower (WARNING: lagtastic and terrible)</A><BR>
